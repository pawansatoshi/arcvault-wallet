...
export default async function handler(req, res) {
    ...
    try {
        ...
        // Format amount strictly to 6 decimals for CCTP
        ...
        const payload = {
            ...
            walletId: walletId, 
            contractAddress: "0x3600000000000000000000000000000000000000", // Arc Native USDC Precompile
            abiFunctionSignature: "approve(address,uint256)",
            abiParameters: [
                "0x8FE6B999Dc680CcFDD5Bf7EB0974218be2542DAA", // Arc TokenMessenger
                rawAmount
            ],
            feeLevel: "MEDIUM",
        ...
        if (!response.ok) throw new Error(`APPROVE_ERROR: ${JSON.stringify(result)}`);
