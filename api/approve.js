...
export default async function handler(req, res) {
    ...
    try {
        ...
        if (!walletId || !amount) return res.status(400).json({ error: "Missing params" });
        ...
        // 🔥 THE FIX: Approve the Arc GatewayWallet instead of the old TokenMessenger
        const gatewayAddress = "0x0077777d7EBA4688BDeF3E311b846F25870A19B9";
        ...
        const payload = {
            ...
            abiParameters: [gatewayAddress, rawAmount],
            feeLevel: "MEDIUM",
